...
export function AreaTextsS1() {
  return (
    <div className=' relative flex items-center mb-16 flex-col'>
      <div className='absolute bottom-[-10%] sm:bottom-[-20%] left-1/2 -translate-x-1/2 w-[320px] sm:w-175 h-64 sm:h-100 rounded-full blur-[80px] sm:blur-[120px] opacity-20 bg-[radial-gradient(theme(colors.emerald.500)_0%,transparent_70%)] pointer-events-none z-0'></div>

      <IntroductionTitle className='text-4xl sm:text-5xl lg:text-6xl text-center max-w-3xl leading-tight tracking-tight mb-6'>
